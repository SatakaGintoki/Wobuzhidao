...
2026-09-13摘要审核稿已获用户确认并正式采用，核心方法、问题分段及关键结果已加粗。摘要保持单页；最新`reading.pdf`为32页、`main.pdf`为117页，共有32页渲染一致。去除加粗命令后与审核稿文字一致，未修改其他章节或数值。详情见 `../../reports/ABSTRACT_APPROVED_20260913.md`。
