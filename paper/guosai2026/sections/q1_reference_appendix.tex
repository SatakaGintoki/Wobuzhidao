...
\]
该方程为零阶Bessel方程。中心有界性排除第二类Bessel函数，取$X(r)=J_0(\lambda r/R)$，其中$J_0,J_1$为第一类Bessel函数。由$J_0'=-J_1$及表面条件$-ku_r(R,t)=hu(R,t)$，得到
...
\]
代入$H$并利用$\int_0^tT_a'(\tau)\dd\tau=T_a(t)-28$，得到
