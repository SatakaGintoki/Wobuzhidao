...
Use bundled scripts as implementation references when they fit the requested argument. For exact template reproduction copy the template; for competition figures follow the project style and approved result data, adapting the workspace copy instead of defaulting to the full reference layout.
